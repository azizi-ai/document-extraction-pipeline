...
GROUND_TRUTH_PATH   = ROOT / "05 Evaluation" / "00 Ground Truth" / "ground_truth_test.json"
EXTRACTION_ROOT     = ROOT / "03 Extraktion" / "02 Test"
OUTPUT_ROOT         = ROOT / "05 Evaluation" / "02 Test"
...
def main() -> None:
    ...
    if len(all_sums) > 1:
        ...
        write_comparison_excel(all_sums, all_vm, OUTPUT_ROOT / "evaluation_comparison_test.xlsx")
    print("\nFertig.")
