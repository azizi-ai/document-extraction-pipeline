...
BASE_MD  = Path(PROJECT_ROOT / "02 Markdown/01 Training/02 MD")
BASE_OUT = Path(PROJECT_ROOT / "03 Extraktion/01 Training")

SOURCES = [
    (BASE_MD / "01 pdfplumber plain", BASE_OUT / "01 pdfplumber plain"),
    (BASE_MD / "02 pdfplumber optimized", BASE_OUT / "02 pdfplumber optimized"),
